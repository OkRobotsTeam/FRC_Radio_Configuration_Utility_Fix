...
public class HostComputer {
            ...
            if (!nicMap.containsValue(temp.getName())) {
               ...
               if (mac != null) {
                  ...
                  if (match != null & nicMap.containsKey(match)) {
                     logger.error("{} adapter found but already mapped Old: {}  New: {}", match, nicMap.get(match), temp.getName());
                  } else if (match != null) {
   ...
   private String getNicMacAddress(NetworkInterface nic) throws HostException {
      ...
      try {
         ...
         throw new HostException("Failed to get MAC address for" + nic.getName(), var5);
      }
   }
   ...
   private String windowsIpConfigAll() throws HostException {
      ...
      try {
         ...
         throw new HostException("Interrupted while waiting for ipconfig/all command to finish", var14);
      } finally {
   ...
   public String[] getInterfaceNames(boolean ethernetOnly) throws HostException {
      ...
      } catch (HostException var6) {
         throw new HostException("Failed to get network interface names", var6);
      }
   }
   ...
   public void changeIpAddress(String address, String subnet, boolean add) throws HostException {
      ...
      } catch (HostException var20) {
         throw new HostException(var20.getMessage(), var20);
      } finally {
   ...
   public void restoreDHCP() throws HostException {
      ...
      try {
         ...
         throw new HostException("Failed to execute command to restore dhcp address", var9);
      } finally {
         this.handler.closeProcess(ipChange);
      }
   }
   ...
   public boolean checkIpAddress(String address) throws HostException {
      ...
      try {
         ...
         throw new HostException("Failed to check ip address", var5);
      }
   }
   ...
   public byte[] getMacAddress() throws HostException {
      ...
      try {
         ...
         throw new HostException("Failed to get MAC address", var4);
      }
   }
   ...
   public String[] getLocalhostIp() throws HostException {
      ...
      } catch (HostException var9) {
         throw new HostException("Failed to get localhost IP address", var9);
      }
   }
   ...
   private List<InetAddress> getLocalhostAddresses() throws HostException {
      try {
         ...
         throw new HostException("Failed to get network interface or its inet addresses", var3);
      }
   }
   ...
   public void flushArp() throws HostException {
      ...
      try {
         ...
         throw new HostException("Failed to execute command to arp cache flush", var9);
      } finally {
   ...
   public String[] pingBroadcast(String target) throws HostException {
      ...
      try {
         ...
         throw new HostException("Failed to send ping broadcast", var14);
      } finally {
   ...
   public boolean pingUntil(String target, int replies, int timeout) throws HostException {
      ...
      try {
         ...
         throw new HostException("Failed to ping " + target, var16);
      } finally {
         this.handler.closeReader(br);
         logger.debug("Ping input stream closed");
         this.handler.closeProcess(ping);
