...
public class DAP1522revB extends FRCRadio {
   ...
   public String validate() throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Error validating bridge settings: " + var7.getMessage(), var7);
      }
   ...
   private String getRadioFirmware(String targetIp) throws RadioException {
      try {
         ...
         throw new RadioException("Failed to get bridge firmware version", var3);
      }
   }
   ...
   private void login(String targetIp, String user, String password) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Bridge login failed", var6);
      }
   }
   ...
   private void wlan(String targetIp) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Failed to program bridge wireless settings", var4);
      }
   }
   ...
   private void network(String targetIp) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Failed to program bridge network settings", var4);
      }
   }
   ...
   private void admin(String targetIp) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Failed to program bridge admin settings", var4);
      }
   }
   ...
   private void qos(String targetIp) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Failed to program bridge QOS settings", var4);
      }
   }
   ...
   private void dhcp(String targetIp) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Failed to program bridge DHCP settings", var4);
      }
   }
   ...
   private void activateSettings(String targetIp) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Failed to activate settings", var3);
      }
   }
