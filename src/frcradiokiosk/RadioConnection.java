...
public class RadioConnection {
   ...
   public static RadioConnection createInputConnection(String url, int timeout) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Failed to initialize input connection for " + url + " webpage", var3);
      }
   }
   ...
   public String getPage(boolean ignoreTimeout) throws RadioException {
      ...
      try {
         ...
         if (!ignoreTimeout) {
            throw new RadioException("Timed out while getting " + this.getStringUrl() + " webpage", var9);
         }

         logger.debug("Timed out; OK");
         var4 = null;
      } catch (IOException var10) {
         throw new RadioException("Failed to get " + this.getStringUrl() + " webpage", var10);
      } finally {
         this.close();
      }
   ...
   public Document pushData(String data) throws RadioException {
      ...
      try {
         ...
         throw new RadioException("Failed to post data to " + this.getStringUrl() + " webpage", var6);
      } finally {
         this.close();
      }
   ...
   private Document getXMLresponse() throws RadioException {
      try {
         ...
         throw new RadioException("Failed to get XML response", var4);
      }
   }
}
