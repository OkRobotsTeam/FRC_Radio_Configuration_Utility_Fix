...
public class DIR825_ddwrt extends FRCRadio {
   ...
   private void wireless() throws RadioException {
      try {
         ...
         throw new RadioException("Failed to program wireless settings", var2);
      }
   }
   ...
   private void lan() throws RadioException {
      try {
         ...
         throw new RadioException("Failed to program network settings", var2);
      }
   }
   ...
   private void misc() throws RadioException {
      try {
         ...
         throw new RadioException("Failed to program administrative radio settings", var2);
      }
   }
